...
export async function adminRoutes(app) {
    app.get("/admin/product-image-rules", { preHandler: requireAdminToken }, async () => {
        const rules = await listProductImageRules(true);
        return { ok: true, rules };
    });
    app.post("/admin/product-image-rules", { preHandler: requireAdminToken }, async (request) => {
        const body = productImageRuleSchema.parse(request.body);
        const rule = await upsertProductImageRule(body);
        return { ok: true, rule };
    });
    app.post("/admin/product-image-rules/:ruleId/status", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.delete("/admin/product-image-rules/:ruleId", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.post("/admin/product-image-rules/:ruleId/restore", { preHandler: requireAdminToken }, async (request) => {
        const { ruleId } = z.object({ ruleId: z.string().uuid() }).parse(request.params);
    ...
    });    app.get("/admin/mockup-templates", { preHandler: requireAdminToken }, async () => {
        const templates = await listAdminMockupTemplates();
        return { ok: true, templates };
    });
    app.post("/admin/mockup-templates", { preHandler: requireAdminToken }, async (request) => {
        const body = mockupTemplateSchema.parse(request.body);
        const template = await upsertAdminMockupTemplate(body);
        return { ok: true, template };
    });
    app.post("/admin/mockup-templates/:templateId/psd", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.post("/admin/mockup-templates/:templateId/template-files", { preHandler: requireAdminToken }, async (request) => {
        const params = z.object({ templateId: z.string().trim().min(2).max(80) }).parse(request.params);
        const files = [];
    ...
    app.post("/admin/mockup-templates/:templateId/test-preview", { preHandler: requireAdminToken }, async (request) => {
        const params = z.object({ templateId: z.string().trim().min(2).max(80) }).parse(request.params);
        const template = await runMockupTemplatePreviewTest(params.templateId);
        return { ok: true, template };
    });
    app.post("/admin/mockup-templates/:templateId/status", { preHandler: requireAdminToken }, async (request) => {
        const params = z.object({ templateId: z.string().trim().min(2).max(80) }).parse(request.params);
    ...
    app.delete("/admin/mockup-templates/:templateId", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.post("/admin/mockup-templates/:templateId/restore", { preHandler: requireAdminToken }, async (request) => {
        const { templateId } = z.object({ templateId: z.string().trim().min(2).max(80) }).parse(request.params);
...
app.post("/admin/users/:userId/restore", { preHandler: requireAdminToken }, async (request) => {
...
app.get("/admin/overview", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.get("/admin/ai-settings", { preHandler: requireAdminToken }, async () => {
        const settings = await readAiSettings();
        return { ok: true, settings: toPublicAiSettings(settings) };
    });
    app.get("/admin/ai-models", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.post("/admin/ai-settings", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.get("/admin/users", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.get("/admin/featured-gallery", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.post("/admin/featured-gallery", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.put("/admin/featured-gallery/:featuredId", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.delete("/admin/featured-gallery/:featuredId", { preHandler: requireAdminToken }, async (request) => {
        const { featuredId } = z.object({ featuredId: z.string().uuid() }).parse(request.params);
    ...
    app.post("/admin/featured-gallery/:featuredId/restore", { preHandler: requireAdminToken }, async (request) => {
        const { featuredId } = z.object({ featuredId: z.string().uuid() }).parse(request.params);
    ...
    app.get("/admin/gallery-assets/:assetId", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.put("/admin/gallery-assets/:assetId", { preHandler: requireAdminToken }, async (request) => {
        const { assetId } = z.object({ assetId: z.string().uuid() }).parse(request.params);
    ...
    app.delete("/admin/gallery-assets/:assetId", { preHandler: requireAdminToken }, async (request) => {
        const { assetId } = z.object({ assetId: z.string().uuid() }).parse(request.params);
        const result = await pool.query(`
    ...
    app.post("/admin/gallery-assets/:assetId/restore", { preHandler: requireAdminToken }, async (request) => {
        const { assetId } = z.object({ assetId: z.string().uuid() }).parse(request.params);
        const result = await pool.query(`
        ...
        return { ok: true, asset: result.rows[0] };
    });    app.get("/admin/gallery-assets", { preHandler: requireAdminToken }, async (request) => {
    ...
    app.get("/admin/orders", { preHandler: requireAdminToken }, async (request) => {
